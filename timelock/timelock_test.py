...
def test_time_elapsed():
    assert get_time_elapsed(datetime(year=1999, month=12, day=31, hour=23, minute=59, second=59, tzinfo = UTC), 
                            datetime(year=2013, month=5, day=6, hour=7, minute=43, second=25, tzinfo = UTC)) == 421141380
